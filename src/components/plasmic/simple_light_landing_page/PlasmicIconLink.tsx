...
import * as sty from "./PlasmicIconLink.module.css" // plasmic-import: ZdrF13Qt_GI38/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(defaultcss.all, sty.svg__gFw6)}
              role={"img"}
            />
          ),
