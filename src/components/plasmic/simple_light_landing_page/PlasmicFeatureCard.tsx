...
import * as sty from "./PlasmicFeatureCard.module.css" // plasmic-import: nc6ccUG19VKId/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? false : true) ? (
        <div
          className={classNames(defaultcss.all, sty.box__jKcSb, {
            [sty.box__long__jKcSbfN2P]: hasVariant(variants, "long", "long"),
          })}
        >
          <div
            className={classNames(defaultcss.all, sty.box__ilVR, {
              [sty.box__long__ilVRfN2P]: hasVariant(variants, "long", "long"),
            })}
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <svg
                  className={classNames(defaultcss.all, sty.svg__y7EsV)}
                  role={"img"}
                />
              ),
      ...
      <div
        className={classNames(defaultcss.all, sty.box__leuwx, {
          [sty.box__long__leuwxfN2P]: hasVariant(variants, "long", "long"),
        })}
      >
        {p.renderPlasmicSlot({
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box__cm2Qg, {
            [sty.box__long__cm2QgfN2P]: hasVariant(variants, "long", "long"),
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg__apxOb)}
                role={"img"}
              />
            ),
