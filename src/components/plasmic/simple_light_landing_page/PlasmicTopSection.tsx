...
import * as sty from "./PlasmicTopSection.module.css" // plasmic-import: 5SUma1BVAohQJ/css

import heroImageA9EMPbruA5Tn9A from "./images/heroImage.png" // plasmic-import: A9eMPbruA5Tn9A/picture
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__s8DdK)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__xsLUe)}
        >
          <div className={classNames(defaultcss.all, sty.box__a58L6)}>
            <div
