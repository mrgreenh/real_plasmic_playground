...
import * as sty from "./PlasmicAvatar.module.css" // plasmic-import: _8JyfKkH85mXpj/css
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <img
            alt={""}
            className={classNames(defaultcss.img, sty.img__dfjKj)}
            role={"img"}
