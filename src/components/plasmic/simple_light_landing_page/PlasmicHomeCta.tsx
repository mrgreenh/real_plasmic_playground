...
import * as sty from "./PlasmicHomeCta.module.css" // plasmic-import: ru8gTUrsyIQDE/css

import SphereIcon from "./icons/PlasmicIcon__Sphere" // plasmic-import: 47GZdHR0jJXQo4/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__herVo)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__fpEfl)}
        >
          <input
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? false : true) ? (
        <div className={classNames(defaultcss.all, sty.box__x18DF)}>
          <SphereIcon
